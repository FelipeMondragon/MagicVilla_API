...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberCreateVM createDTO)
        {
            ...
            {
                var response = await _villaNumberService.CreateAsync<APIResponse>(createDTO.VillaNumber);
                if (response != null && response.IsSucces)
                {
        ...
        {
            var response = await _villaNumberService.DeleteAsync<APIResponse>(villaDTO.VillaNumber.VillaNo);
            if (response != null && response.IsSucces)
            {
                return RedirectToAction(nameof(IndexVillaNumber));
            }
